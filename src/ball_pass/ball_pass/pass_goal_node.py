...
class PassGoalPublisher(Node):
    def __init__(self):
        super().__init__("pass_goal_publisher")
        ...
        self.create_subscription(PointStamped, self.human_topic, self._human_cb, qos)
        ...
        self.get_logger().info(
            f"PassGoalPublisher started. ball={self.ball_topic}, human={self.human_topic}, "
